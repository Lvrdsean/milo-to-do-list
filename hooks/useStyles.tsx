            ...
            if (isResoponsiveStyle(style)) {
                switch (true) {
                    case width < Breakpoints.phoneSm:
                        ...
                        if (newStyles[key].hasOwnProperty("regular")) {
                            console.log("This has StyleStates!");
                        }

                        console.log(
                            `Phone small - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    case width < Breakpoints.phone:
                        ...
                        console.log(
                            `Phone - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    case width < Breakpoints.tabletSm:
                        ...
                        console.log(
                            `Table small - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    case width < Breakpoints.tablet:
                        ...
                        console.log(
                            `Tablet - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    case width < Breakpoints.desktopSm:
                        ...
                        console.log(
                            `Desktop small - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    case width < Breakpoints.desktop:
                        ...
                        console.log(
                            `Desktop - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
                    default:
                        ...
                        console.log(
                            `Default - ${width}px newStyles: ${JSON.stringify(
                                newStyles,
                            )}`,
                        );
                        break;
